...
const HomePage = () => {
    ...
    let charData = [
        { weekNumber: 4, name: 'الاسبوع الرابع', حجز: 0 },
        { weekNumber: 3, name: 'الاسبوع الثالث', حجز: 0 },
        { weekNumber: 2, name: 'الاسبوع الثاني', حجز: 0 },
        ...
        <Stack spacing={2} marginTop={1}>
            ...
            <Stack direction="row" flexWrap="wrap" gap={2}>
                ...
                <DashCard
                    title="المدفوعات"
                    counter={`${
                        reservations?.data.reservations_count ?? 0
                    } ريال`}
